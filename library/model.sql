...
-- Table `OPTIC`.`TIENDA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`TIENDA` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`PRODUCTO` ;
...
-- Table `OPTIC`.`USUARIO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`USUARIO` ;

CREATE TABLE IF NOT EXISTS `OPTIC`.`USUARIO` (
  `USU_ID` INT NOT NULL AUTO_INCREMENT,
  `USU_NAME` VARCHAR(45) NULL,
  `USU_MAIL` VARCHAR(100) NULL,
  `USU_RUT` VARCHAR(45) NULL,
  `USU_PASS` VARCHAR(45) NULL,
  `USU_ACTIVE` INT NULL,
  `USU_TYPE` INT NULL,
  `TIENDA_TIE_ID` INT NOT NULL,
  PRIMARY KEY (`USU_ID`),
  UNIQUE INDEX `USU_ID_UNIQUE` (`USU_ID` ASC),
  INDEX `fk_USUARIO_TIENDA1_idx` (`TIENDA_TIE_ID` ASC),
...
-- Table `OPTIC`.`VENTA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`VENTA` ;
...
CREATE TABLE IF NOT EXISTS `OPTIC`.`VENTA` (
  ...
  `VEN_CLI_NAME` VARCHAR(45) NULL,
  `VEN_CLI_PHONE` INT NULL,
  PRIMARY KEY (`VEN_ID`),
  UNIQUE INDEX `VEN_ID_UNIQUE` (`VEN_ID` ASC),
  INDEX `fk_VENTA_TIENDA1_idx` (`TIENDA_TIE_ID` ASC),
  INDEX `fk_VENTA_USUARIO1_idx` (`USUARIO_USU_ID` ASC),
  ...
  CONSTRAINT `fk_VENTA_USUARIO1`
    ...
    REFERENCES `OPTIC`.`USUARIO` (`USU_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `OPTIC`.`DETALLE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`DETALLE` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`METODO_PAGO` ;
...
-- Table `OPTIC`.`ABONO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`ABONO` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`DESPACHO` ;

CREATE TABLE IF NOT EXISTS `OPTIC`.`DESPACHO` (
  `DES_ID` INT NOT NULL AUTO_INCREMENT,
  `DES_DATE` DATE NULL,
  `DES_CRISTAL` VARCHAR(450) NULL,
  `DES_ALTURA` VARCHAR(450) NULL,
  `VENTA_VEN_ID` INT NOT NULL,
  PRIMARY KEY (`DES_ID`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`CAPTADOR` ;

CREATE TABLE IF NOT EXISTS `OPTIC`.`CAPTADOR` (
  `CAP_ID` INT NOT NULL AUTO_INCREMENT,
  `CAP_NAME` VARCHAR(450) NULL,
  `CAP_PHONE` VARCHAR(45) NULL,
  `CAP_ACTIVE` INT NULL,
  PRIMARY KEY (`CAP_ID`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`COMISION` ;
...
-- Table `OPTIC`.`PAGO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`PAGO` ;
...
-- Table `OPTIC`.`CRISTAL`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPTIC`.`CRISTAL` ;
