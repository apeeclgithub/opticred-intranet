...
<div class="row">
  <div class="form-group col-xs-3">
   <label for="addSaleDateFinish">Realizar de Entrega</label><input class="form-control" type="text" id="addSaleDateFinish" name="addSaleDateFinish" disabled="disabled">
   </div>  
  <div class="form-group col-xs-4">
