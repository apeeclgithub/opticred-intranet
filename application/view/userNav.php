    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Actualmente se encuentra en la tienda del "<?php echo $_SESSION['user']['store']?>"</h4>
            </div>
            <div class="modal-body">
                <p>¿Desea cambiar a la tienda del "<?php echo ($_SESSION['user']['store'] == 'Tercero')? 'Quinto' : 'Tercero' ?>"</p>
            </div>
