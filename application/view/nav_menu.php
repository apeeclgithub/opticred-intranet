  ...
  <div class="menu-list">
    ...
    <ul id="menu-content" class="menu-content collapse out">
      ...
      <ul class="sub-menu collapse" id="sails">
        ...
        <a href="#"><li><span class="glyphicon glyphicon-menu-right"></span> Cierre de Caja</li></a>
        ...
        <a href="insumos.php"><li><span class="glyphicon glyphicon-menu-right"></span> Insumos</li></a>
      </ul>
