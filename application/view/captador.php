		...
		<table id="captadorTabla" class="table table-striped table-bordered tableWidth" cellspacing="0" width="100%">
			...
			<tbody>
				<tr>
					...
					<td>61</td>
					<td>61</td>
					<td><a href="#" class="alignIconTable" data-toggle="modal" data-target="#editCaptadorConfirmDialog"><span class="glyphicon glyphicon-pencil"></span></a><a href="#" class="alignIconTable" data-toggle="modal" data-target="#deleteCaptadorConfirmDialog"><span class="glyphicon glyphicon-trash"></span></a></td>
				</tr>
				<tr>
					...
					<form class="form-horizontal">
						<fieldset class="">
							...
							<div class="form-group">
								<label class="col-md-4 control-label" for="precio">Ingrese E-mail</label>  
								<div class="col-md-4">
									<input type="text" placeholder="aa@aa.cl" class="form-control input-md" >
								</div>
							</div>
							<!-- Text input-->
							<div class="form-group">
