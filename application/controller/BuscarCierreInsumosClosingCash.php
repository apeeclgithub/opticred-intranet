<table id="buscarCierrelistInsumosClosingCash" class="table table-striped table-bordered tableWidth" cellspacing="0" width="100%">
	...
	<tbody>
		...
		$objInsumo->buscarCierrelistInsumosClosingCash();
...
<?php
$objInsumo = new Insumo();
$objInsumo->buscarCierreTotalInsumoClosingCash($_SESSION["user"]["store"]);
...
<script type="text/javascript" language="javascript">
$(document).ready(function() {
	$('#buscarCierreTotalInsumoClosingCash').DataTable();
} );
</script>